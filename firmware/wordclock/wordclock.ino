...
const int w_cold[3] =      {15, 0, 4  }; // do we need these?
const int w_cool[3] =      {15, 5, 4}; // do we need these?
const int w_warm[3] =      {15, 10, 5}; // do we need these?
const int w_hot[3] =        { 9,  2,  2 }; // do we need these?
